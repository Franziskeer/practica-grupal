 ...
 */
            ...
            /**
            *  FormatoNotificacion bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = FormatoNotificacion
                Namespace URI = http://www.example.org/Notificacion/
                           ...
                           */
                           public  boolean getTipo(){
                            ...
                            /**
                               ...
                               * @param param Tipo
                               */
                               public void setTipo(boolean param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FormatoNotificacion",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FormatoNotificacion",
    ...
    public static class Factory{
        ...
        */
        public static FormatoNotificacion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FormatoNotificacion object =
                new FormatoNotificacion();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FormatoNotificacion".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FormatoNotificacion)org.example.www.notificacion.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
